...
<body>
	<table style="margin-left: 120px;">
		<tr>
			<td><img src="../../assets/img/LOGO PTUN PALU NEW.png" height="80" style="margin: 0px 0px 0px 250px"></td>
		</tr>
		<tr>
			<td align="center">
				<h4>SURVEY KEPUASAN PELAYANAN PENGADILAN TATA USAHA NEGARA PALU</h4>
				<h4>KUESIONER INI MOHON DIISI UNTUK MENINGKATKAN PELAYANAN</h4>
				<h4>PENGADILAN TATA USAHA NEGARA PALU KEPADA PARA PENCARI KEADILAN</h4>
			</td>
		</tr>
	</table>
	<div>
	...
	<table width="95%" id="tabel-data" border="1" cellpadding="4">
		...
		<tr>
			<td>12</td>
			<td>Saran :<p style="font-style: italic;font-size: 12px;">(Apabila masih ada pelayanan kami yang kurang, diharapkan untuk menuliskan alasan kekurangan tersebut di kolom sebelah sehingga kami dapat memperbaikinya</p></td>
