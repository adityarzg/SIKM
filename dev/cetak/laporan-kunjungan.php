...
<body>
	<table>
		<tr>
			<td><img src="../../assets/img/LOGO PTUN PALU NEW.png" height="80" style="margin: 0px 100px 0px 250px"></td>
			<td align="center" >
				<h1>Pengadilan Tata Usaha Negara Palu</h1>
				<h3>Jalan. Prof. Moh Yamin, SH. No.52, Kota Palu</h3>
				<h4>https://ptun-palu.go.id - Telp: (0451) 483385</h4>
			</td>
		</tr>
	</table>
	<div>
	...
	<table align="center" style="text-align: center;">
		<tr>
			<td><p style="font-weight: bold">Laporan Data Kunjungan</p></td>
		</tr>
		<tr>
			<td>
				<?php  
	...
	<table width="90%" id="tabel-data">
		...
		<?php
			include("../../koneksi.php");
			$no = 1;
			$sql = mysqli_query($koneksi, "SELECT * FROM tbl_visit WHERE tanggal BETWEEN '$tgl_awal' and '$tgl_akhir'") or die(mysqli_error($db));
	...
	<div id="footer-tanggal">
        Palu, <?php echo tgl_eng_to_ind("$hari_ini"); ?>
    </div>
