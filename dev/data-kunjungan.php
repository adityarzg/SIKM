...
<head>
    <title>Data Kunjungan - e-SKM</title>
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title" id="myModalLabel1"><i style="margin-right:7px" class="fas fa-print"></i> Cetak Laporan Kunjungan </h5>
                            </div>
                            <form action="cetak/laporan-kunjungan.php" method="POST" target="_blank">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Daftar Kunjungan</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Informasi Kunjungan PTUN Palu</p>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-striped table-bordered table-hover my-0 data" id="dataTable">
                                    ...
                                    <tbody class="text-nowrap">
                                        ...
                                        $no = 1;
                                        $sql = mysqli_query($koneksi, 'select * from tbl_visit order by tanggal desc');
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php echo " <td style='white-space: nowrap;'><a class=\"btn btn-sm btn-danger btn-fill fas fa-trash\" href=\"form-delete-kunjungan.php?id=" . $data['id'] . "\" onclick=\"return confirm('Apakah anda yakin akan menghapus data ini?')\"></a></td>"; ?>
                                            </tr>
                                        <?php
                                        }
                                        ?>
