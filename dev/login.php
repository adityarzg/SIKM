...
<body class="bg-gradient-primary">
    <div class="container">
        <div class="row justify-content-center" style="margin-top: 79px;">
            <div class="col-md-9 col-lg-11 col-xl-9">
                            ...
                            <div class="col-lg-6 offset-lg-3 offset-xl-3">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h5 class="text-dark mb-4">Silahkan Login Terlebih Dahulu</h5>
                                    </div>
                                    <form class="user" action="proses-login.php" method="POST">
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="text" placeholder="Username" name="username" autofocus>
                                        </div>
                                        <div class="form-group">
